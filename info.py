...
API_HASH = environ.get('API_HASH', 'a802120afab6de81ed7ac91158754faa')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://telegra.ph/file/9688c892ad2f2cf5c3f68.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '732556620').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001526485271').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001522168084') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001529899497')).split()]  # For Multiple Id Use One Space Between Each.
...
S_DB_URI = environ.get('S_DB_URI', "")   # This Db is for File Data Store When First Db Istechvjclonefilterb
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+eDjzTT2Ua6kwMTI1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@movie_reqest_group_2') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/On_air_Filter_bot')
